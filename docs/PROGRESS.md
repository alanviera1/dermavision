...
| 2026-08-09 | ACNE04 (uso académico) + ACNE04-v2 (anotaciones COCO) como base de detección de acné | Wu et al. ICCV 2019; Gazeau et al. MICCAI 2024 |
...
| 2026-08-09 | Fitzpatrick17k: CSV público descargado; imágenes requieren formulario a autores | CC BY-NC-SA 3.0 — válido para tesis |
| 2026-08-09 | Datos de pacientes: uso académico exclusivo, sin redistribución; reportar en tesis | Ética |
